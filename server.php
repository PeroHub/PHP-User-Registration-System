...
if($password != $password2) array_push($errors, "Passwords does not match");
...
if ($user) {
    ...
    if($user['email'] === $email) array_push($errors, " This email already has a register username");
...
//Register user if error check by bypass
